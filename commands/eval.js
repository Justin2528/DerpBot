...
module.exports.run = async (bot, message, args) => {
  ...
  console.log(`\n${message.author.username}#${message.author.discriminator} Used d>eval Command On ${message.guild.name}`)
    ...
    if (message.author.id !==  ownerid) {
        ...
        try {
         ...
         if (evaled.includes(bot.token)) {
          ...
          .setColor(0xFF5733)
          .setFooter(message.createdAt, message.author.displayAvatarURL)
